...
shared(msg) actor class AloneStorage(_owner: Principal) {
    ...
    public shared(msg) func setMultiNftCanisterId(multiNftCid: Principal) : async Bool {
        assert(msg.caller == owner_);
        multiNft_canister_id_ := multiNftCid;
        return true;
    };

    public query func getMultiNftCanisterId() : async Principal {
